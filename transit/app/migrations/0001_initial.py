# Generated by Django 4.1.7 on 2023-09-24 20:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('manager', 'manager'), ('supervisor', 'supervisor'), ('agent', 'agent')], help_text='This field define the user access level to the transit panel.', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charges', models.DecimalField(decimal_places=2, max_digits=15, verbose_name='Amount due($)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('short_range', models.DecimalField(decimal_places=2, max_digits=15, verbose_name='pay/short-range trip in $')),
                ('mid_range', models.DecimalField(decimal_places=2, max_digits=15, verbose_name='pay/mid-range trip in $')),
                ('long_range', models.DecimalField(decimal_places=2, max_digits=15, verbose_name='pay/long-range trip in $')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('management', models.ForeignKey(limit_choices_to={'is_agent': False, 'is_superuser': False}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='trips', to=settings.AUTH_USER_MODEL)),
                ('transporters', models.ManyToManyField(related_name='trips', to='app.transporter')),
            ],
        ),
        migrations.CreateModel(
            name='Report',
